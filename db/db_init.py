...
server2 = Server(status=True, address='127.0.0.1')
server3 = Server(status=True, address='127.0.0.1')
server4 = Server(status=True, address='127.0.0.1')
server5 = Server(status=True, address='127.0.0.1')
server6 = Server(status=True, address='127.0.0.1')
